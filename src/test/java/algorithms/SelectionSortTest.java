...
class SelectionSortTest {
    ...
    void deveOrdenarArrayDesordenado() {
        ...
        Estatisticas estatisticas =
                new Estatisticas("SelectionSort", array.length);
    ...
    @Test
    void deveRealizarQuantidadeEsperadaDeTrocas() {
        int[] array = {5, 4, 3, 2, 1};
    ...
    void deveManterQuantidadeDeElementos() {
        ...
        Estatisticas estatisticas =
                new Estatisticas("SelectionSort", tamanhoAntes);
    ...
    @Test
    void deveRealizarComparacoesMesmoEmArrayOrdenado() {
        int[] array = {1, 2, 3, 4, 5};
